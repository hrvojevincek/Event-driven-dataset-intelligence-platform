...
class IntakeWorker(SqsConsumer):
    """Consumes project.submitted (and legacy query.submitted) on the intake queue."""
    ...
    async def handle_message(self, message: dict[str, Any]) -> None:
        ...
        if detail_type == DETAIL_TYPE_QUERY_SUBMITTED:
